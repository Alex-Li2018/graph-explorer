...
export declare const relationshipEventHandlers: (selection: Selection<SVGGElement, RelationshipModel, BaseType, unknown>, trigger: (event: string, rel: RelationshipModel, _event: Event) => void) => Selection<SVGGElement, RelationshipModel, BaseType, unknown>;
