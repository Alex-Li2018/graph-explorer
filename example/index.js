...
typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('core-js/modules/es.object.to-string.js'), require('core-js/modules/web.dom-collections.for-each.js'), require('core-js/modules/es.array.filter.js'), require('core-js/modules/es.array.join.js'), require('d3-ease'), require('d3-selection'), require('d3-zoom'), require('core-js/modules/es.array.slice.js'), require('core-js/modules/es.array.map.js'), require('@babel/runtime/helpers/createForOfIteratorHelperLoose'), require('core-js/modules/es.array.from.js'), require('core-js/modules/es.string.iterator.js'), require('core-js/modules/es.array.sort.js'), require('core-js/modules/es.regexp.to-string.js'), require('core-js/modules/es.array.splice.js'), require('core-js/modules/es.regexp.exec.js'), require('core-js/modules/es.string.replace.js'), require('d3-force')) :
typeof define === 'function' && define.amd ? define(['exports', 'core-js/modules/es.object.to-string.js', 'core-js/modules/web.dom-collections.for-each.js', 'core-js/modules/es.array.filter.js', 'core-js/modules/es.array.join.js', 'd3-ease', 'd3-selection', 'd3-zoom', 'core-js/modules/es.array.slice.js', 'core-js/modules/es.array.map.js', '@babel/runtime/helpers/createForOfIteratorHelperLoose', 'core-js/modules/es.array.from.js', 'core-js/modules/es.string.iterator.js', 'core-js/modules/es.array.sort.js', 'core-js/modules/es.regexp.to-string.js', 'core-js/modules/es.array.splice.js', 'core-js/modules/es.regexp.exec.js', 'core-js/modules/es.string.replace.js', 'd3-force'], factory) :
(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.GraphExplorer = {}, null, null, null, null, global.d3Ease, global.d3Selection, global.d3Zoom, null, null, global._createForOfIteratorHelperLoose, null, null, null, null, null, null, null, global.d3Force));
})(this, (function (exports, es_object_toString_js, web_domCollections_forEach_js, es_array_filter_js, es_array_join_js, d3Ease, d3Selection, d3Zoom, es_array_slice_js, es_array_map_js, _createForOfIteratorHelperLoose, es_array_from_js, es_string_iterator_js, es_array_sort_js, es_regexp_toString_js, es_array_splice_js, es_regexp_exec_js, es_string_replace_js, d3Force) { 'use strict';
...
var PairwiseArcsRelationshipRouting = /*#__PURE__*/function () {
  ...
  _proto.distributeAnglesForLoopArrows = function distributeAnglesForLoopArrows(nodePairs, relationships) {
    for (var _iterator = _createForOfIteratorHelperLoose__default["default"](nodePairs), _step; !(_step = _iterator()).done;) {
  ...
  _proto.layoutRelationships = function layoutRelationships(graph) {
    ...
    for (var _iterator2 = _createForOfIteratorHelperLoose__default["default"](nodePairs), _step2; !(_step2 = _iterator2()).done;) {
      var nodePair = _step2.value;
      for (var _iterator3 = _createForOfIteratorHelperLoose__default["default"](nodePair.relationships), _step3; !(_step3 = _iterator3()).done;) {
...
var ForceSimulation = /*#__PURE__*/function () {
  function ForceSimulation(render) {
    ...
    this.simulation = d3Force.forceSimulation().velocityDecay(VELOCITY_DECAY).force('charge', d3Force.forceManyBody().strength(FORCE_CHARGE)).force('centerX', d3Force.forceX(0).strength(FORCE_CENTER_X)).force('centerY', d3Force.forceY(0).strength(FORCE_CENTER_Y)).alphaMin(DEFAULT_ALPHA_MIN).on('tick', function () {
  ...
  _proto.updateNodes = function updateNodes(graph) {
    ...
    this.simulation.nodes(nodes).force('collide', d3Force.forceCollide().radius(FORCE_COLLIDE_RADIUS));
  };
  _proto.updateRelationships = function updateRelationships(graph) {
    var relationships = oneRelationshipPerPairOfNodes(graph);
    this.simulation.force('link', d3Force.forceLink(relationships).id(function (node) {
      return node.id;
  ...
  function Visualization(element, measureSize, onZoomEvent, onDisplayZoomWheelInfoMessage, graph, style, isFullscreen, wheelZoomRequiresModKey, initialZoomToFit) {
    ...
    this.zoomToFitViewport = function () {
      ...
      if (scaleAndOffset) {
        ...
        _this.zoomBehavior.transform(_this.root, d3Zoom.zoomIdentity.scale(Math.min(scale, ZOOM_MAX_SCALE)).translate(centerPointOffset.x, centerPointOffset.y));
      }
    };
