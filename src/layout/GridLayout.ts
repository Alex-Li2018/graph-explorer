...
import {
  ...
  getDegree,
  isNaN,
  getFuncByUnknownType,
  isArray,
} from '../utils/utils';

import { PointTuple, IndexMap, GridLayoutOptions } from '../types';
...
export class GridLayout {
  ...
  public execute() {
    ...
    // sort nodes by value
    layoutNodes.sort((n1, n2) => (n2 as any)[sortBy] - (n1 as any)[sortBy]);
